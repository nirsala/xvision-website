...
// נושאים לסבב דו-שבועי (14 נושאים ← עודכן עם מתחרים)
const TOPICS = [
  ...
  { title: 'מסך LED לבית פרטי — מדריך לבחירה נכונה', keyword: 'מסכי LED לבתים פרטיים' },
  { title: 'שילוט דיגיטלי לחדרי כושר — נראות ומכירות', keyword: 'שילוט דיגיטלי לחדרי כושר' },
